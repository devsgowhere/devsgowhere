  ...
  describe('meetup org page', () => {
    test("junior devs sg", async () => {
      ...
      expect(result).toMatchObject({
        ...
        // description: '',
        // content: '',
        tags: ['Linux', 'PHP', 'Open Source', 'Web Design', 'Ruby', 'System Administration', 'Web Development', 'Mobile Technology', 'Mobile Development', 'Agile Project Management', 'Computer Programming', 'HTML5', 'Infrastructure as Code', 'Technology'],
